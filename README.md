...
![Music Playlist Service class diagram](src/resources/documentation/music_playlist_class.png)

[source](src/resources/mastery-task1-music-playlist-CD.puml)
...
![Get Playlist sequence diagram](src/resources/get_playlist.png)

[source](src/resources/mastery-task1-get-playlist-SD.puml)

#### Create Playlist:

![Create Playlist sequence diagram](src/resources/create_playlist.png)

[source](src/resources/mastery-task1-create-playlist-SD.puml)
